...
const Navbar = () => {
  ...
  const serviceItems = [
    { title: 'Balıkesir Çekici', path: '/hizmetler' },
    { title: 'Balıkesir Yol Yardım', path: '/balikesir-yol-yardim' },
    { title: 'Balıkesir Oto Kurtarma', path: '/balikesir-oto-kurtarma' },
    { title: 'Balıkesir Araç Kurtarma', path: '/balikesir-arac-kurtarma' },
    { title: 'Balıkesir Oto Çekici', path: '/balikesir-oto-cekici' },
    { title: 'Oto Çekici Balıkesir', path: '/oto-cekici-balikesir' },
    { title: 'Oto Kurtarma Balıkesir', path: '/oto-kurtarma-balikesir' },
  ];
            ...
            <div className="flex items-center">
              <Link href="/" className="flex-shrink-0 flex items-center space-x-2">
                <div className="relative h-10 w-10 sm:h-12 sm:w-12">
                  <Image
                    src="/logo.jpeg"
                    alt="Balıkesir Bulut Oto Çekici"
                    fill
