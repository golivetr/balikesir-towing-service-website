...
const locations = [
  {
    ...
    description: "Balıkesir Merkez ve tüm ilçeler",
    isMain: true
  },
  {
    name: "Edremit",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 text-center mb-2">
            Balıkesir Oto Çekici Hizmet Bölgelerimiz
          </h2>
          <p className="text-lg text-gray-600 text-center">
            Balıkesir'in tüm ilçelerinde 7/24 oto çekici ve yol yardım hizmeti sunuyoruz.
          </p>
        </div>
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-lg p-8">
          <div className="max-w-3xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 mb-6 text-center">
              Balıkesir Oto Çekici ve Yol Yardım Hizmeti
            </h3>
            <div className="prose prose-lg mx-auto text-gray-600">
              ...
              <p className="mb-4">
                Balıkesir oto çekici hizmetimizle, aracınızın güvenliğini en üst düzeyde tutarak 
              ...
              <p>
                Balıkesir çekici hizmetimiz, acil durumlarınızda en kısa sürede yanınızda olmak için 
                hazır bekliyor. Aracınızın çekilmesi veya yol yardımı gerektiğinde, Balıkesir'in 
                her noktasına hızlı ulaşım sağlıyoruz. Güvenilir ve profesyonel çekici hizmetimizle 
                Balıkesir'de yanınızdayız.
              </p>
            </div>
          </div>
        </div>
