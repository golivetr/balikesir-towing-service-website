      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative h-[500px] rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/photo/p18.jpeg"
              alt="Balıkesir Oto Çekici Profesyonel Ekip"
              fill
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              20 yılı aşkın tecrübemizle Balıkesir ve çevresinde profesyonel oto çekici ve yol yardım hizmetleri sunuyoruz. Modern ekipmanlarımız ve uzman ekibimizle 7/24 yanınızdayız.
            </p>
