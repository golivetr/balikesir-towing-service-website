...
export const metadata: Metadata = {
  title: 'Balıkesir Araç Kurtarma Hizmetleri | 7/24 Profesyonel Araç Kurtarma',
  description: "Balıkesir'de 7/24 profesyonel araç kurtarma hizmeti. Kaza sonrası kurtarma, çukur ve mahsur kalma durumlarında hızlı ve güvenli çözümler.",
  keywords: 'balıkesir araç kurtarma, araç kurtarma balıkesir, 7/24 araç kurtarma, kaza sonrası kurtarma, çukur kurtarma, mahsur kalma kurtarma, balıkesir araç kurtarma hizmeti',
};

const services = [
  {
    title: 'Araç Kurtarma Hizmeti',
    description: 'Balıkesir\'in her noktasında 7/24 profesyonel araç kurtarma hizmeti sunuyoruz. Modern kurtarma ekipmanlarımız ve uzman ekibimizle yanınızdayız.',
            ...
            <div className="space-y-6 text-center lg:text-left">
              <div className="inline-block">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 tracking-tight">
                  Balıkesir Araç Kurtarma Hizmetleri
                </h1>
            ...
            <div className="space-y-8 text-center lg:text-right">
              <div>
                ...
                <p className="text-blue-100 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  Balıkesir'in tüm ilçelerinde 7/24 profesyonel araç kurtarma hizmetleri sunuyoruz. 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-blue mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
              Balıkesir Araç Kurtarma Hizmetlerimiz
            </h2>
            <div className="space-y-6 text-gray-600">
              <p>
                Balıkesir Araç Kurtarma hizmetimiz, şehrin her noktasında 7/24 profesyonel kurtarma hizmeti sunar. 
              ...
              <p>
                Balıkesir Araç Kurtarma olarak, müşteri memnuniyetini ön planda tutuyor, şeffaf fiyatlandırma 
