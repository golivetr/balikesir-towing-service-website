...
export default function ContactPage() {
  ...
  const address = "Balıkesir, Türkiye";
            ...
            <div className="space-y-8 text-center lg:text-right">
              <div>
                <h2 className="text-3xl md:text-4xl font-semibold text-white mb-6">
                  Balıkesir'in Güvenilir Yol Yardım Partneri
                </h2>
                <p className="text-blue-100 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  7/24 profesyonel oto çekici ve yol yardım hizmetleri sunuyoruz. Balıkesir'in tüm ilçelerinde hızlı ve güvenilir çözümler için hemen arayın. Deneyimli ekibimiz ve modern ekipmanlarımızla yanınızdayız.
                </p>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gradient-to-r from-purple-600 to-purple-700 rounded-2xl p-8 text-white">
            ...
            <p className="text-purple-100 mb-6">
              Balıkesir'in her noktasına hizmet veriyoruz. Bizi ziyaret edin.
            </p>
            <a
