...
export const metadata: Metadata = {
  title: 'Balıkesir Oto Çekici Hizmetleri | 7/24 Profesyonel Oto Çekici',
  description: "Balıkesir'de 7/24 profesyonel oto çekici hizmeti. Tüm araç tipleri için güvenli ve hızlı çekici hizmeti. Uygun fiyat garantisi.",
  keywords: 'balıkesir oto çekici, oto çekici balıkesir, 7/24 oto çekici, profesyonel oto çekici, güvenli oto çekici, hızlı oto çekici, balıkesir oto çekici hizmeti',
};

const services = [
  {
    title: 'Oto Çekici Hizmeti',
    description: 'Balıkesir\'in her noktasında 7/24 profesyonel oto çekici hizmeti sunuyoruz. Modern çekici araçlarımız ve uzman ekibimizle yanınızdayız.',
            ...
            <div className="space-y-6 text-center lg:text-left">
              <div className="inline-block">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 tracking-tight">
                  Balıkesir Oto Çekici Hizmetleri
                </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-blue mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
              Balıkesir Oto Çekici Hizmetlerimiz
            </h2>
            <div className="space-y-6 text-gray-600">
              <p>
                Balıkesir Oto Çekici hizmetimiz, şehrin her noktasında 7/24 profesyonel çekici hizmeti sunar. 
                ...
                Balıkesir'in tüm ilçelerinde aynı kalite ve hızda sunulmaktadır.
              </p>
              <p>
              ...
              <p>
                Balıkesir Oto Çekici olarak, müşteri memnuniyetini ön planda tutuyor, şeffaf fiyatlandırma 
