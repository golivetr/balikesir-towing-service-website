...
export const metadata: Metadata = {
  title: 'Hakkımızda | Balıkesir Oto Çekici ve Yol Yardım Hizmetleri',
  description: "Balıkesir'de 7/24 oto çekici ve yol yardım hizmeti sunan güvenilir firma. Deneyimli ekibimiz ve modern ekipmanlarımızla yanınızdayız.",
  keywords: 'balıkesir oto çekici, oto çekici balıkesir, yol yardım, 7/24 çekici, profesyonel çekici, balıkesir çekici hizmeti',
};
    ...
    <div className="bg-gray-50">
        ...
        <div className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 font-light max-w-2xl mx-auto">
              Balıkesir Bulut Oto Çekici: Balıkesir'de 7/24 güvenilir çekici ve yol yardım hizmeti.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative w-full h-64 md:h-80 rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/photo/p16.jpeg"
              alt="Balıkesir Oto Çekici Hizmeti"
              fill
          ...
          <div>
            <p className="text-lg text-gray-700">
              <span className="font-bold text-blue-800">Balıkesir Bulut Oto Çekici</span> olarak, Balıkesir oto çekici ve yol yardım sektöründe yıllardır edindiğimiz tecrübe ile, müşteri memnuniyetini ve güvenli hizmeti ön planda tutuyoruz. 7/24 kesintisiz hizmet anlayışımız, hızlı müdahale süremiz ve Balıkesir'in tüm ilçelerine ulaşabilen geniş servis ağımız ile aracınız nerede olursa olsun yanınızdayız. Modern çekici filomuz ve uzman ekibimizle, Balıkesir çekici hizmetlerimizde kalite ve güveni bir araya getiriyoruz.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-700 text-lg">
              <p><span className="font-semibold text-blue-800">Vizyonumuz:</span> Balıkesir'de oto çekici ve yol yardım sektöründe yenilikçi, güvenilir ve lider bir marka olmak.</p>
              <p><span className="font-semibold text-blue-800">Misyonumuz:</span> 7/24 hızlı, güvenli ve kaliteli yol yardım ve çekici hizmetiyle Balıkesir'de her zaman yanınızda olmak.</p>
            </div>
          </div>
          {/* Right: Image */}
          <div className="relative w-full h-72 md:h-96 rounded-2xl overflow-hidden shadow-xl">
            <Image
              src="/photo/p12.jpeg"
              alt="Balıkesir Bulut Oto Çekici Vizyon"
              fill
              className="object-cover rounded-2xl"
              sizes="(max-width: 768px) 100vw, 50vw"
            />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h2 className="text-3xl font-bold text-blue-900 text-center mb-10">
          Neden Balıkesir Bulut Oto Çekici?
        </h2>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="relative bg-gradient-to-br from-blue-100 via-white to-blue-50 rounded-2xl shadow-xl p-10 flex flex-col items-center text-center overflow-hidden">
          ...
          <blockquote className="text-xl md:text-2xl font-semibold text-blue-900 mb-4 leading-relaxed">
            &quot;Balıkesir Bulut Oto Çekici ile aracım yolda kaldığında çok hızlı ve güvenilir bir hizmet aldım. Gerçekten profesyonel ve müşteri odaklı bir ekip!&quot;
          </blockquote>
