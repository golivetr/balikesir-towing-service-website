...
export const metadata: Metadata = {
  title: 'Galeri | Balıkesir Oto Çekici ve Yol Yardım Hizmetleri',
  description: "Balıkesir'de oto çekici ve yol yardım hizmetlerimizden görüntüler. Profesyonel ekipmanlarımız ve hizmet kalitemiz.",
            ...
            <div className="space-y-8 text-center lg:text-right">
              <div>
                ...
                <p className="text-blue-100 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  Balıkesir'de sunduğumuz oto çekici ve yol yardım hizmetlerimizden kareler. 
