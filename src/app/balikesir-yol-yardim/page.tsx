...
export const metadata: Metadata = {
  title: 'Balıkesir Yol Yardım Hizmetleri | 7/24 Profesyonel Yol Yardım',
  description: "Balıkesir'de 7/24 profesyonel yol yardım hizmeti. Akü takviyesi, lastik değişimi, yakıt ikmali ve daha fazlası için hemen arayın. Hızlı ve güvenilir çözümler.",
  keywords: 'balıkesir yol yardım, yol yardım balıkesir, 7/24 yol yardım, akü takviyesi, lastik değişimi, yakıt ikmali, balıkesir yol yardım hizmeti',
  openGraph: {
    title: 'Balıkesir Yol Yardım Hizmetleri | 7/24 Profesyonel Yol Yardım',
    description: "Balıkesir'in her noktasında 7/24 profesyonel yol yardım hizmeti sunuyoruz. Deneyimli ekibimiz ve modern ekipmanlarımızla yanınızdayız."
  }
};
            ...
            <div className="space-y-6 text-center lg:text-left">
              <div className="inline-block">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 tracking-tight">
                  Balıkesir Yol Yardım Hizmetleri
                </h1>
            ...
            <div className="space-y-8 text-center lg:text-right">
              <div>
                ...
                <p className="text-blue-100 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  Balıkesir&apos;in tüm ilçelerinde 7/24 profesyonel yol yardım hizmetleri sunuyoruz. 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-blue mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
              Balıkesir Yol Yardım Hizmetlerimiz
            </h2>
            <div className="space-y-6 text-gray-600">
              <p>
                Balıkesir Yol Yardım hizmetimiz, şehir genelinde 7/24 hızlı müdahale sağlar. 
                ...
                yol yardım hizmetlerimiz, Balıkesir&apos;in tüm ilçelerinde aynı kalite ve hızda sunulmaktadır.
              </p>
              <p>
              ...
              <p>
                Balıkesir Yol Yardım olarak, müşteri memnuniyetini ön planda tutuyor, şeffaf fiyatlandırma 
