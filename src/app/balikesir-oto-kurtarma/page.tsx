...
export const metadata: Metadata = {
  title: 'Balıkesir Oto Kurtarma Hizmetleri | 7/24 Profesyonel Oto Kurtarma',
  ...
  keywords: 'balıkesir oto kurtarma, oto kurtarma balıkesir, 7/24 oto kurtarma, kaza sonrası kurtarma, çukur kurtarma, mahsur kalma kurtarma, balıkesir oto kurtarma hizmeti',
};
...
export default function BalikesirOtoKurtarmaPage() {
            ...
            <div className="space-y-6 text-center lg:text-left">
              <div className="inline-block">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 tracking-tight">
                  Balıkesir Oto Kurtarma Hizmetleri
                </h1>
            ...
            <div className="space-y-8 text-center lg:text-right">
              <div>
                ...
                <p className="text-blue-100 text-lg leading-relaxed max-w-2xl mx-auto lg:mx-0">
                  Balıkesir'in tüm ilçelerinde 7/24 profesyonel oto kurtarma hizmetleri sunuyoruz. 
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-blue mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">
              Balıkesir Oto Kurtarma Hizmetlerimiz
            </h2>
            <div className="space-y-6 text-gray-600">
              <p>
                Balıkesir Oto Kurtarma hizmetimiz, şehrin her noktasında 7/24 profesyonel kurtarma hizmeti sunar. 
              ...
              <p>
                Balıkesir Oto Kurtarma olarak, müşteri memnuniyetini ön planda tutuyor, şeffaf fiyatlandırma 
